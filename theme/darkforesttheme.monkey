...
Class DarkForestTheme Implements Theme
	...
	Method New(tileWidth, tileHeight)
		...
		forestImage = LoadImage("images/dark_forest.png")
		Local forest:BackgroundLayer = New BackgroundLayer(forestImage, 0.6, -1, 800.0)
		backgroundLayers.Push(forest)
	End
